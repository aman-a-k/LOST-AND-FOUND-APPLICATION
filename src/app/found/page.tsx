    ...
    <div className="max-w-2xl mx-auto px-4 py-12">
      ...
      >
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-[#142544] mb-2">Report Found Item</h1>
          <p className="text-gray-500">Help reunite a lost item with its owner.</p>
        </div>
        ...
        <form onSubmit={onSubmit} className="space-y-6">
          ...
          <div>
            ...
            <textarea name="description" rows={3} className="corporate-input" placeholder="Describe the item..."></textarea>
          </div>
          
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
            <div>
              <label className="block text-sm font-semibold text-[#142544] mb-2">Location Found</label>
              <input type="text" name="location" className="corporate-input" placeholder="e.g. Library 2nd floor" />
            </div>
            <div>
              <label className="block text-sm font-semibold text-[#142544] mb-2">Date Found</label>
              <input type="datetime-local" name="date_found" className="corporate-input" />
            </div>
          </div>
